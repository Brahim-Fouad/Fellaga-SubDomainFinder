# Fellaga documentation

This directory contains the maintained user and operator documentation for Fellaga.
...
Project policies and contributor material live at the repository root:

- [README](../README.md)
- [Contributing guide](../CONTRIBUTING.md)
- [Security policy](../SECURITY.md)
- [Changelog](../CHANGELOG.md)
- [Corpus provenance](../data/CORPUS_LICENSE.md)
- [Third-party notices](../THIRD_PARTY_NOTICES.md)

All examples use reserved `.example` names. Replace them only with domains that you own or are explicitly authorized to assess.
